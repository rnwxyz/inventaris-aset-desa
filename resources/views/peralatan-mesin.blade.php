<x-layout.app>
    ...
    <div class="d-flex">
        ...
        <div class="text-end pt-3 pb-3 ps-5">
            <!-- print -->
            <a href="#" class="btn btn-success shadow-sm">Print</a>
        </div>
        <div class="text-end pt-3 pb-3 ps-3">
            <!-- export -->
            <a href="#" class="btn btn-info shadow-sm" style="color: white;">Unduh Laporan</a>
        </div>
        ...
        <table class="table table-bordered table-hover" style="width: 100%;">
            <thead>
                <tr class="text-center align-middle bg-blue" style="font-size: small;">
                    ...
                    <th rowspan="2" scope="col" style="width: 20%;">Nama Barang</th>
                    <th rowspan="2" scope="col" style="width: 10%;">Kode Barang</th>
                    <th rowspan="2" scope="col" style="width: 5%;">NUP</th>
                    <th rowspan="2" scope="col" style="width: 10%;">Merk/Type</th>
