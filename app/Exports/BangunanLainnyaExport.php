...
class BangunanLainnyaExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize, WithEvents, WithColumnWidths
{
    /**
    ...
    public function collection()
    {
        ...
        return BangunanLainnyaModel::all()->map(function ($bangunanLainnya, $key) {
            $bangunanLainnya->no = $key + 1;
            return $bangunanLainnya;
        });
    }
    ...
    public function map($bangunanLainnya): array
    {
        return [
            $bangunanLainnya->no,
            $bangunanLainnya->nama_barang,
            $bangunanLainnya->kode_barang,
            $bangunanLainnya->nup,
            $bangunanLainnya->merk,
            $bangunanLainnya->tahun_perolehan,
            // format rupiah
            $bangunanLainnya->nilai_perolehan ? 'Rp ' . number_format($bangunanLainnya->nilai_perolehan, 0, ',', '.') : '',
            $bangunanLainnya->b ? '✓' : '',
            $bangunanLainnya->rr ? '✓' : '',
            $bangunanLainnya->rb ? '✓' : '',
            $bangunanLainnya->keterangan
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                BangunanLainnyaModel::all()->map(function ($bangunanLainnya, $key) use ($sheet) {
                    $row = $key + 6;
                ...
                $users = BangunanLainnyaModel::all();
                $row = $users->count() + 6;
