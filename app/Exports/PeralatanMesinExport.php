...
class PeralatanMesinExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize, WithEvents, WithColumnWidths
{
    /**
    ...
    public function collection()
    {
        ...
        return PeralatanMesinModel::all()->map(function ($peralatanMesin, $key) {
            $peralatanMesin->no = $key + 1;
            return $peralatanMesin;
        });
    }
    ...
    public function map($peralatanMesin): array
    {
        return [
            $peralatanMesin->no,
            $peralatanMesin->nama_barang,
            $peralatanMesin->kode_barang,
            $peralatanMesin->nup,
            $peralatanMesin->merk,
            $peralatanMesin->tahun_perolehan,
            // format rupiah
            $peralatanMesin->nilai_perolehan ? 'Rp ' . number_format($peralatanMesin->nilai_perolehan, 0, ',', '.') : '',
            $peralatanMesin->b ? '✓' : '',
            $peralatanMesin->rr ? '✓' : '',
            $peralatanMesin->rb ? '✓' : '',
            $peralatanMesin->keterangan
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                PeralatanMesinModel::all()->map(function ($peralatanMesin, $key) use ($sheet) {
                    $row = $key + 6;
